  ...
  return (
    <section id="dealer" className="py-20 gradient-primary relative overflow-hidden group">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10 animate-fade-in-up">
        <h2 className="font-serif font-medium text-4xl lg:text-5xl text-white tracking-tight mb-6 drop-shadow-md">Trở Thành Đại Lý La Santé</h2>
        <p className="text-white/90 text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
          Gia nhập mạng lưới đại lý phân phối rộng khắp của chúng tôi. Tận hưởng chính sách chiết khấu độc quyền, hỗ trợ truyền thông và cơ hội kinh doanh sinh lời cao.
        </p>
        <Link href="#contact" className="inline-block px-12 py-4 rounded-full bg-white text-[#f37435] font-medium text-lg hover:shadow-2xl hover:scale-105 active:scale-95 transition-all outline outline-2 outline-white outline-offset-4 hover:outline-offset-2">
          Đăng Ký Ngay
        </Link>
      </div>
    </section>
